...
#Pruefen ob supported OS installiert:
lsb_release -a
echo "Check OS...Debian 11/12 or Ubuntu needed"
sleep 3
#Update...
...
sudo ufw allow 20551/tcp
sudo ufw allow 20555/tcp
...
cd ~/
wget https://storage.googleapis.com/team-drop/snapshots/changi/snapshot-changi-1644800.tar.gz
tar -xvzf ${LATEST} -C ~/.defi/data/changi/
